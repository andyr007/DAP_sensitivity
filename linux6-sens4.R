...
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Side_Grass"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Side_Grass"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Side_Grass"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Side_Grass"	# path of the model
...
write.csv(time, file = "6 cores 4-1.csv")
# Second Site -------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WF"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WF"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WF"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WF"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
# Set min and max for variable ranges. Ranges are plus and minus 0.2 * value
clay.val = str.toe.clay
clay.min = clay.val - (clay.val * 0.2)
clay.max = clay.val + (clay.val * 0.2)
silt.val = str.toe.silt
sand.val = str.toe.sand
bulk.val = str.toe.bulk
bulk.min = bulk.val - (bulk.val * 0.2)
bulk.max = bulk.val + (bulk.val * 0.2)
ph.val = str.toe.ph
ph.min = ph.val - (ph.val * 0.2)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-2.csv")
# Third Site --------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCF"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCF"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCF"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCF"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-3.csv")
# Fourth Site -------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCMF"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCMF"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCMF"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_WCMF"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-4.csv")
# Fifth Site --------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_OPP"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_OPP"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_OPP"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_OPP"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-5.csv")
# Sixth Site --------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_Grass"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_Grass"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_Grass"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/StrattonSims/Sensitivity Files/LHC_yao/Toe_Grass"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-6.csv")
# Seventh Site ------------------------------------------------------------
...
# Settings for the simulation runs:
#====================================================================
path = "/media/sf_M_DRIVE/WalshSims/Sensitivity Files/LHC_yao/Summit_WF"	# path of the modelfolder
climpath = "/media/sf_M_DRIVE/WalshSims/Sensitivity Files/LHC_yao/Summit_WF"	# path of the climate data
soilpath = "/media/sf_M_DRIVE/WalshSims/Sensitivity Files/LHC_yao/Summit_WF"	# path of the soil data
modelpath = "/media/sf_M_DRIVE/WalshSims/Sensitivity Files/LHC_yao/Summit_WF"	# path of the model
testvars = c("global", "temp", "prec", "clay", "bulk", "ph")
start_year = styr
end_year = enyr
growth_fac = 0.45 # this is the growth factor (only necessary to get the yield)
...
# Set min and max for variable ranges. Ranges are plus and minus 0.2 * value
clay.val = wal.sum.clay
clay.min = clay.val - (clay.val * 0.2)
clay.max = clay.val + (clay.val * 0.2)
silt.val = wal.sum.silt
sand.val = wal.sum.sand
bulk.val = wal.sum.bulk
bulk.min = bulk.val - (bulk.val * 0.2)
bulk.max = bulk.val + (bulk.val * 0.2)
ph.val = wal.sum.ph
ph.min = ph.val - (ph.val * 0.2)
...
time = Sys.time()
setwd("~/Dropbox/R Projects/USDA DAP/Sensitivities/")
write.csv(time, file = "6 cores 4-7.csv")